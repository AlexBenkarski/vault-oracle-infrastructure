# -*- encoding: utf-8 -*-
# stub: fluent-plugin-oracle-telemetry-out-lumberjack 2.9.24 ruby lib

Gem::Specification.new do |s|
  s.name = "fluent-plugin-oracle-telemetry-out-lumberjack".freeze
  s.version = "2.9.24"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "build_date" => "2025-06-16 08:46:52 UTC", "commit_hash" => "not-available" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["Unified Agent team".freeze]
  s.date = "2025-06-16"
  s.description = "Oracle Telemetry FluentD Plugins : Lumberjack output plugin".freeze
  ...
  s.summary = "OCI Fluentd Lumberjack output plugin".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<hydra_pika_client>.freeze, ["= 1.2"])
    ...
    s.add_dependency(%q<hydra_pika_client>.freeze, ["= 1.2"])
