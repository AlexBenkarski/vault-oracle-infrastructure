# -*- encoding: utf-8 -*-
# stub: fluent-plugin-oracle-out-datamesh 2.9.24 ruby lib

Gem::Specification.new do |s|
  s.name = "fluent-plugin-oracle-out-datamesh".freeze
  s.version = "2.9.24"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "build_date" => "2025-06-16 08:46:21 UTC", "commit_hash" => "not-available" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["OCI Observability Team".freeze]
  s.date = "2025-06-16"
  s.description = "Oracle Observability FluentD Plugins : Logging output plugin for DM Log Ingestion".freeze
  s.email = ["no-reply@support.oracle.com".freeze]
  s.extra_rdoc_files = ["README.md".freeze]
  s.files = ["README.md".freeze]
  s.homepage = "https://confluence.oci.oraclecorp.com/display/UA/Unified+Agent+Home".freeze
  s.licenses = ["UPL-1.0".freeze, "Apache-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 3.0".freeze)
  s.rubygems_version = "3.2.33".freeze
  s.summary = "OCI Fluentd Logging output plugin able to talk to DM Log Ingestion API".freeze
