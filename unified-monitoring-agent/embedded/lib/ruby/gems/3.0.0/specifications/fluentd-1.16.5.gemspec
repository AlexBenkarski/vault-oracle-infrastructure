...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<serverengine>.freeze, [">= 2.3.2", "< 3.0.0"])
    s.add_runtime_dependency(%q<http_parser.rb>.freeze, [">= 0.5.1", "< 0.9.0"])
    s.add_runtime_dependency(%q<sigdump>.freeze, ["~> 0.2.5"])
    ...
    s.add_runtime_dependency(%q<webrick>.freeze, ["~> 1.4"])
    ...
    s.add_dependency(%q<serverengine>.freeze, [">= 2.3.2", "< 3.0.0"])
    s.add_dependency(%q<http_parser.rb>.freeze, [">= 0.5.1", "< 0.9.0"])
    s.add_dependency(%q<sigdump>.freeze, ["~> 0.2.5"])
    ...
    s.add_dependency(%q<webrick>.freeze, ["~> 1.4"])
