# -*- encoding: utf-8 -*-
# stub: fluent-plugin-oracle-k8s-metadata-filter 2.9.24 ruby lib

Gem::Specification.new do |s|
  s.name = "fluent-plugin-oracle-k8s-metadata-filter".freeze
  s.version = "2.9.24"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "build_date" => "2025-06-16 08:46:06 UTC", "commit_hash" => "not-available" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["CRS Eagles Dev Team".freeze]
  s.date = "2025-06-16"
  s.description = "Filter plugin to add Kubernetes metadata".freeze
  s.email = ["eagles_scrum_grp@oracle.com".freeze]
  ...
  s.summary = "Fluentd filter plugin to add Kubernetes metadata".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<lru_redux>.freeze, [">= 1.0.0"])
    ...
    s.add_dependency(%q<lru_redux>.freeze, [">= 1.0.0"])
