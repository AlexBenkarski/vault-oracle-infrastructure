# -*- encoding: utf-8 -*-
# stub: fluent-plugin-oracle-telemetry-in-openmetrics-k8s 2.9.24 ruby lib

Gem::Specification.new do |s|
  s.name = "fluent-plugin-oracle-telemetry-in-openmetrics-k8s".freeze
  s.version = "2.9.24"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "build_date" => "2025-06-16 08:48:25 UTC", "commit_hash" => "not-available" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["Unified Agent team".freeze]
  s.date = "2025-06-16"
  s.description = "Oracle Telemetry FluentD Plugins : Kubernetes metrics input module".freeze
  ...
  s.summary = "OCI Fluentd Kubernetes metrics input module".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<fluent-plugin-oracle-telemetry-in-openmetrics>.freeze, [">= 0.0.0.a"])
    s.add_runtime_dependency(%q<fluent-plugin-oracle-telemetry-out-monitoring>.freeze, [">= 0.0.0.a"])
    s.add_runtime_dependency(%q<k8s-ruby>.freeze, ["~> 0.16.0"])
    ...
    s.add_dependency(%q<fluent-plugin-oracle-telemetry-in-openmetrics>.freeze, [">= 0.0.0.a"])
    s.add_dependency(%q<fluent-plugin-oracle-telemetry-out-monitoring>.freeze, [">= 0.0.0.a"])
    s.add_dependency(%q<k8s-ruby>.freeze, ["~> 0.16.0"])
