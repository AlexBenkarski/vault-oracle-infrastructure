# -*- encoding: utf-8 -*-
# stub: fluent-plugin-oracle-telemetry-in-g1gc 2.9.24 ruby lib

Gem::Specification.new do |s|
  s.name = "fluent-plugin-oracle-telemetry-in-g1gc".freeze
  s.version = "2.9.24"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "build_date" => "2025-06-16 08:47:26 UTC", "commit_hash" => "not-available" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["Unified Agent team".freeze]
  s.date = "2025-06-16"
  s.description = "Oracle Telemetry FluentD Plugins : JVM G1 GC logs input".freeze
  ...
  s.summary = "OCI Fluentd  JVM G1GC logs input".freeze
