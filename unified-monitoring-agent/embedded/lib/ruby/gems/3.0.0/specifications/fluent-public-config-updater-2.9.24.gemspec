# -*- encoding: utf-8 -*-
# stub: fluent-public-config-updater 2.9.24 ruby lib

Gem::Specification.new do |s|
  s.name = "fluent-public-config-updater".freeze
  s.version = "2.9.24"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "build_date" => "2025-06-16 08:49:12 UTC", "commit_hash" => "not-available" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["Unified Agent team".freeze]
  s.date = "2025-06-16"
  s.description = "Oracle Telemetry FluentD Config Updater".freeze
  ...
  s.summary = "Oracle Telemetry FluentD Config Updater".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<hydra_controlplane_client>.freeze, ["= 1.1.112"])
    s.add_runtime_dependency(%q<retriable>.freeze, ["= 3.1.2"])
    s.add_runtime_dependency(%q<fluent-plugin-oracle-telemetry-common>.freeze, [">= 0.0.0.a"])
    s.add_runtime_dependency(%q<fluent-plugin-oracle-telemetry-common-public>.freeze, [">= 0.0.0.a"])
    s.add_runtime_dependency(%q<fluent-plugin-oracle-telemetry-out-logging>.freeze, [">= 0.0.0.a"])
    ...
    s.add_dependency(%q<hydra_controlplane_client>.freeze, ["= 1.1.112"])
    s.add_dependency(%q<retriable>.freeze, ["= 3.1.2"])
    s.add_dependency(%q<fluent-plugin-oracle-telemetry-common>.freeze, [">= 0.0.0.a"])
    s.add_dependency(%q<fluent-plugin-oracle-telemetry-common-public>.freeze, [">= 0.0.0.a"])
    s.add_dependency(%q<fluent-plugin-oracle-telemetry-out-logging>.freeze, [">= 0.0.0.a"])
