...
module OCI
  # the summary of the service categories.
  #
  class HydraControlplaneClient::Models::ServiceCategorySummary
    # **[Required]** The OCID of the resource.
    # @return [String]
    attr_accessor :id

    # **[Required]** The id of the service to which the category belongs
    # @return [String]
    ...
    def hash
      [id, service_id, display_name, resource_type, name, endpoint, is_proxy_enabled, category_stage, is_logging_enabled, time_created, time_last_modified, parameters].hash
    end
