...
module OCI
  ...
  class HydraControlplaneClient::Models::SiemService < HydraControlplaneClient::Models::Source
    # **[Required]** Log category.
    # @return [String]
