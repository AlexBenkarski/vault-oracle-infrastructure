...
module OCI
  ...
  #
  class HydraControlplaneClient::Models::LogRule
    ...
    def hash
      [id, query, compartment_id, time_created, time_last_modified, query_start_policy, query_recurrences, threshold, display_name, custom_log_id, defined_tags, freeform_tags, recommendation_text, description, log_rule_status, lifecycle_state, severity, operator].hash
    end
