...
module OCI
  ...
  class HydraControlplaneClient::Models::UnifiedAgentLoggingSource
    SOURCE_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentCustomPluginLogSource' if type == 'CUSTOM_PLUGIN'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentWindowsEventSource' if type == 'WINDOWS_EVENT_LOG'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentTailLogSource' if type == 'LOG_TAIL'

      # TODO: Log a warning when the subtype is not found.
      'OCI::HydraControlplaneClient::Models::UnifiedAgentLoggingSource'
    end
