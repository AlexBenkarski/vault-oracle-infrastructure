...
module OCI
  # Record section of UnifiedAgentMetricsSource object.
  class HydraControlplaneClient::Models::UnifiedAgentMetricsRecordInput
    # **[Required]** Namespace to emit the metrics.
    # @return [String]
    attr_accessor :namespace

    # Resource group to emit the metrics.
    # @return [String]
