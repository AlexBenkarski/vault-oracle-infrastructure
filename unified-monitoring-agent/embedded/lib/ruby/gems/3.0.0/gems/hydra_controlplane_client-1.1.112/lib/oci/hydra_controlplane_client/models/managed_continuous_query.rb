...
module OCI
  ...
  #
  class HydraControlplaneClient::Models::ManagedContinuousQuery
    ...
    def hash
      [id, query, compartment_id, stream_id, time_created, time_updated, query_start_time, interval_in_minutes, threshold, display_name, defined_tags, freeform_tags, description, is_enabled, lifecycle_state, severity, operator].hash
    end
