...
module OCI
  ...
  class HydraControlplaneClient::Models::UpdateLogDetails
    ...
    # @return [OCI::HydraControlplaneClient::Models::UpdateConfigurationDetails]
    ...
    def self.swagger_types
      {
        ...
        'configuration': :'OCI::HydraControlplaneClient::Models::UpdateConfigurationDetails'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [OCI::HydraControlplaneClient::Models::UpdateConfigurationDetails] :configuration The value to assign to the {#configuration} property
