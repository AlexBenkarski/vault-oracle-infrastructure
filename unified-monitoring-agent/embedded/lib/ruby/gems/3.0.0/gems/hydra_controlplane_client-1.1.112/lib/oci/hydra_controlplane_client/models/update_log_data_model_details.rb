...
module OCI
  # Log data model update content request details.
  class HydraControlplaneClient::Models::UpdateLogDataModelDetails
    ...
    def hash
      [display_name, description, template, log_data_model_details, freeform_tags, defined_tags].hash
    end
