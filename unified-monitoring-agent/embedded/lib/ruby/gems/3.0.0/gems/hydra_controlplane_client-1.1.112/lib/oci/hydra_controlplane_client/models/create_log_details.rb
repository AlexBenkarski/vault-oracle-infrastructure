...
module OCI
  ...
  class HydraControlplaneClient::Models::CreateLogDetails
    LOG_TYPE_ENUM = [
      LOG_TYPE_CUSTOM = 'CUSTOM'.freeze,
      LOG_TYPE_SERVICE = 'SERVICE'.freeze,
      LOG_TYPE_SIEM = 'SIEM'.freeze
    ].freeze
    ...
    # @return [OCI::HydraControlplaneClient::Models::Configuration]
    ...
    def self.swagger_types
      {
        ...
        'configuration': :'OCI::HydraControlplaneClient::Models::Configuration',
    ...
    # @option attributes [OCI::HydraControlplaneClient::Models::Configuration] :configuration The value to assign to the {#configuration} property
