...
module OCI
  # The details to create a service registry entry.
  class HydraControlplaneClient::Models::CreateServiceRegistryDetails
    ...
    def hash
      [lifecycle_state, tenancy_id, compartment_id, display_name, name, service_principal_name, namespace, email, jira_queue, ingestion_allowed_tenancies, is_hidden_in_registry_list, is_notifying_log_reclamation, is_implementing_get_logging, service_type, service_stage, la_allowed_tenancies, test_allowed_tenancies].hash
    end
