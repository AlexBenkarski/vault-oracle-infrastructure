...
require 'date'
require_relative 'log_pipeline_input'

# rubocop:disable Lint/UnneededCopDisableDirective, Metrics/LineLength
module OCI
  # Describes properties for the OCI Logging Log Object as a source for the Log Pipeline.
  # Takes just one parameter - Log Object OCID
  #
  class HydraControlplaneClient::Models::LogPipelineInputLogObject < HydraControlplaneClient::Models::LogPipelineInput
    ...
    def initialize(attributes = {})
      ...
      attributes['inputType'] = 'OCI_LOG_OBJECT'
