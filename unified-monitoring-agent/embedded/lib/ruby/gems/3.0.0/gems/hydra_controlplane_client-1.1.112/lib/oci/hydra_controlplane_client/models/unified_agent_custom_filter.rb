...
module OCI
  ...
  class HydraControlplaneClient::Models::UnifiedAgentCustomFilter < HydraControlplaneClient::Models::UnifiedAgentLoggingFilter
    ...
    # @return [Array<OCI::HydraControlplaneClient::Models::UnifiedAgentCustomSection>]
    ...
    def self.swagger_types
      {
        ...
        'custom_sections': :'Array<OCI::HydraControlplaneClient::Models::UnifiedAgentCustomSection>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::HydraControlplaneClient::Models::UnifiedAgentCustomSection>] :custom_sections The value to assign to the {#custom_sections} property
