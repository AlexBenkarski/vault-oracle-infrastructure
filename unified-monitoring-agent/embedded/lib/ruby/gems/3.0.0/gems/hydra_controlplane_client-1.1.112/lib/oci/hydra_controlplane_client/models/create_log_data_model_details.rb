...
module OCI
  ...
  class HydraControlplaneClient::Models::CreateLogDataModelDetails
    ...
    def hash
      [display_name, compartment_id, description, template, log_data_model_details, freeform_tags, defined_tags].hash
    end
