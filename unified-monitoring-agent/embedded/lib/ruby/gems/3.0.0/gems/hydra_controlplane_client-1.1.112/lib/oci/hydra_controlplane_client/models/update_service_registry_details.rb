...
module OCI
  # Contains parameters that need to be updated for an existing service registry configuration.
  #
  class HydraControlplaneClient::Models::UpdateServiceRegistryDetails
    ...
    # service principal of the partner service.
    # @return [String]
    attr_accessor :service_principal_name

    # email of distribution list for partner service team.
    # @return [String]
    attr_accessor :email

    # JIRA queue of the partner service team.
    # @return [String]
    ...
    # Flag to hide in registry list or not.
    # @return [BOOLEAN]
    attr_accessor :is_hidden_in_registry_list

    # Flag to notify log reclamation.
    # @return [BOOLEAN]
    attr_accessor :is_notifying_log_reclamation

    # Flag to check if the partner service implements get logging api.
    # @return [BOOLEAN]
    attr_accessor :is_implementing_get_logging

    # Enum to specify service stage.
    # @return [String]
    attr_accessor :service_stage

    # List of tenancies allowed to have access to partner service when its LA
    # @return [Array<String>]
    attr_accessor :la_allowed_tenancies

    # List of tenancies allowed to have access to test partner service
    # @return [Array<String>]
    attr_accessor :test_allowed_tenancies
    ...
    def self.attribute_map
      {
        ...
        'la_allowed_tenancies': :'laAllowedTenancies',
        'test_allowed_tenancies': :'testAllowedTenancies'
    ...
    def self.swagger_types
      {
        ...
        'la_allowed_tenancies': :'Array<String>',
        'test_allowed_tenancies': :'Array<String>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<String>] :la_allowed_tenancies The value to assign to the {#la_allowed_tenancies} property
    # @option attributes [Array<String>] :test_allowed_tenancies The value to assign to the {#test_allowed_tenancies} property
    def initialize(attributes = {})
      ...
      self.la_allowed_tenancies = attributes[:'laAllowedTenancies'] if attributes[:'laAllowedTenancies']

      raise 'You cannot provide both :laAllowedTenancies and :la_allowed_tenancies' if attributes.key?(:'laAllowedTenancies') && attributes.key?(:'la_allowed_tenancies')

      self.la_allowed_tenancies = attributes[:'la_allowed_tenancies'] if attributes[:'la_allowed_tenancies']

      self.test_allowed_tenancies = attributes[:'testAllowedTenancies'] if attributes[:'testAllowedTenancies']

      raise 'You cannot provide both :testAllowedTenancies and :test_allowed_tenancies' if attributes.key?(:'testAllowedTenancies') && attributes.key?(:'test_allowed_tenancies')

      self.test_allowed_tenancies = attributes[:'test_allowed_tenancies'] if attributes[:'test_allowed_tenancies']
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        la_allowed_tenancies == other.la_allowed_tenancies &&
        test_allowed_tenancies == other.test_allowed_tenancies
    end
    ...
    def hash
      [lifecycle_state, display_name, service_principal_name, email, jira_queue, ingestion_allowed_tenancies, is_hidden_in_registry_list, is_notifying_log_reclamation, is_implementing_get_logging, service_stage, la_allowed_tenancies, test_allowed_tenancies].hash
    end
