...
module OCI
  # Log rule update object request details.
  class HydraControlplaneClient::Models::UpdateLogRuleDetails
    ...
    def hash
      [query, query_recurrences, threshold, display_name, custom_log_id, defined_tags, freeform_tags, query_start_policy, log_rule_status, description, recommendation_text, severity, operator].hash
    end
