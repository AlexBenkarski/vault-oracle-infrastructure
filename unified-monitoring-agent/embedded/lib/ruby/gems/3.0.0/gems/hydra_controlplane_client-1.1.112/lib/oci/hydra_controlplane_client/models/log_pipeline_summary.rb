...
module OCI
  # Log Pipeline object summary.
  class HydraControlplaneClient::Models::LogPipelineSummary
    ...
    def hash
      [id, display_name, description, inputs, routes, lifecycle_state, is_enabled, defined_tags, freeform_tags, system_tags, time_created, time_last_modified, compartment_id].hash
    end
