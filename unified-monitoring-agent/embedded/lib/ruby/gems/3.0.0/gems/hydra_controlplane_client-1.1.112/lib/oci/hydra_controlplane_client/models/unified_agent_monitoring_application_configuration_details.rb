...
module OCI
  ...
  class HydraControlplaneClient::Models::UnifiedAgentMonitoringApplicationConfigurationDetails
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_KUBERNETES = 'KUBERNETES'.freeze,
      SOURCE_TYPE_TAIL = 'TAIL'.freeze,
      SOURCE_TYPE_URL = 'URL'.freeze,
      SOURCE_TYPE_UMA_METRICS = 'UMA_METRICS'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentKubernetesConfigurationDetails' if type == 'KUBERNETES'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentUrlConfigurationDetails' if type == 'URL'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentOpenmetricsTailConfigurationDetails' if type == 'TAIL'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentMetricsConfigurationDetails' if type == 'UMA_METRICS'

      # TODO: Log a warning when the subtype is not found.
      'OCI::HydraControlplaneClient::Models::UnifiedAgentMonitoringApplicationConfigurationDetails'
    end
