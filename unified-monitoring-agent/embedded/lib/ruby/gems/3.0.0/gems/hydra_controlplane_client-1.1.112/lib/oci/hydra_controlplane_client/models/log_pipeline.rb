...
module OCI
  # Represents a log pipeline resource.
  class HydraControlplaneClient::Models::LogPipeline
    ...
    # **[Required]** Inputs for the Log Pipeline
    # @return [Array<OCI::HydraControlplaneClient::Models::LogPipelineInput>]
    attr_accessor :inputs

    # **[Required]** Routes for the Log Pipeline
    # @return [Array<OCI::HydraControlplaneClient::Models::LogPipelineRoute>]
    ...
    def self.swagger_types
      {
        ...
        'is_enabled': :'BOOLEAN',
        'description': :'String',
        'inputs': :'Array<OCI::HydraControlplaneClient::Models::LogPipelineInput>',
        'routes': :'Array<OCI::HydraControlplaneClient::Models::LogPipelineRoute>',
    ...
    # @option attributes [Array<OCI::HydraControlplaneClient::Models::LogPipelineInput>] :inputs The value to assign to the {#inputs} property
    # @option attributes [Array<OCI::HydraControlplaneClient::Models::LogPipelineRoute>] :routes The value to assign to the {#routes} property
    ...
    def hash
      [id, display_name, compartment_id, is_enabled, description, inputs, routes, defined_tags, freeform_tags, system_tags, lifecycle_state, time_created, time_last_modified].hash
    end
