...
module OCI
  # Log pipeline create request details.
  class HydraControlplaneClient::Models::CreateLogPipelineDetails
    ...
    def hash
      [display_name, compartment_id, description, is_enabled, inputs, routes, freeform_tags, defined_tags].hash
    end
