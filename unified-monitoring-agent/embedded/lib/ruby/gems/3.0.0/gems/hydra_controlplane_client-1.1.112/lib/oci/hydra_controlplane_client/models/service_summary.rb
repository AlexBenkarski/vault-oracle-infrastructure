...
module OCI
  ...
  class HydraControlplaneClient::Models::ServiceSummary
    ...
    # @return [Array<OCI::HydraControlplaneClient::Models::ResourceType>]
    ...
    def self.swagger_types
      {
        ...
        'name': :'String',
        'id': :'String',
        'resource_types': :'Array<OCI::HydraControlplaneClient::Models::ResourceType>'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [Array<OCI::HydraControlplaneClient::Models::ResourceType>] :resource_types The value to assign to the {#resource_types} property
