...
module OCI
  # A replication event.
  class HydraControlplaneClient::Models::ReplicationEvent
    OBJECT_TYPE_ENUM = [
      OBJECT_TYPE_LOG_OBJECT = 'LOG_OBJECT'.freeze,
      OBJECT_TYPE_LOG_GROUP = 'LOG_GROUP'.freeze,
      OBJECT_TYPE_LOG_DATA_MODEL = 'LOG_DATA_MODEL'.freeze,
      OBJECT_TYPE_LOG_RULE = 'LOG_RULE'.freeze,
      OBJECT_TYPE_CONTINUOUS_QUERY = 'CONTINUOUS_QUERY'.freeze,
      OBJECT_TYPE_MANAGED_CONTINUOUS_QUERY = 'MANAGED_CONTINUOUS_QUERY'.freeze,
      OBJECT_TYPE_LOG_PIPELINE = 'LOG_PIPELINE'.freeze,
    ...
    # **[Required]** Type of the requested object.
    # @return [String]
    attr_reader :object_type

    # **[Required]** Version of the requested object.
    # @return [String]
    attr_accessor :version

    # **[Required]** Serialized data of the requested object.
    # @return [String]
    attr_accessor :object

    # **[Required]** State of the requested object.
    # @return [String]
    attr_reader :state

    # **[Required]** Etag of the object in the payload.
    # @return [String]
    attr_accessor :etag
    ...
    def hash
      [object_type, version, object, state, etag].hash
    end
