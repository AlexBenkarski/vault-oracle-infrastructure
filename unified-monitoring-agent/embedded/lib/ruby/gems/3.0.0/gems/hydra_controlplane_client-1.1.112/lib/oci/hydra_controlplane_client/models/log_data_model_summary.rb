...
module OCI
  # Log data model summary object for LIST operation.
  class HydraControlplaneClient::Models::LogDataModelSummary
    ...
    def hash
      [id, display_name, compartment_id, description, template, lifecycle_state, validity_state, time_created, time_last_modified, freeform_tags, defined_tags].hash
    end
