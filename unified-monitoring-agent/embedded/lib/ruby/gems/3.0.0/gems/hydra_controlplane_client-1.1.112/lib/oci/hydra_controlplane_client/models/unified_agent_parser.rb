...
module OCI
  ...
  class HydraControlplaneClient::Models::UnifiedAgentParser
    PARSER_TYPE_ENUM = [
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentMultilineGrokParser' if type == 'MULTILINE_GROK'
      return 'OCI::HydraControlplaneClient::Models::UnifiedJSONParser' if type == 'JSON'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentGrokParser' if type == 'GROK'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentNoneParser' if type == 'NONE'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentSyslogParser' if type == 'SYSLOG'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentOpenmetricsParser' if type == 'OPENMETRICS'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentAuditdParser' if type == 'AUDITD'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentApache2Parser' if type == 'APACHE2'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentRegexParser' if type == 'REGEXP'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentMultilineParser' if type == 'MULTILINE'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentTsvParser' if type == 'TSV'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentCriParser' if type == 'CRI'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentApacheErrorParser' if type == 'APACHE_ERROR'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentMsgpackParser' if type == 'MSGPACK'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentCsvParser' if type == 'CSV'

      # TODO: Log a warning when the subtype is not found.
      'OCI::HydraControlplaneClient::Models::UnifiedAgentParser'
    end
