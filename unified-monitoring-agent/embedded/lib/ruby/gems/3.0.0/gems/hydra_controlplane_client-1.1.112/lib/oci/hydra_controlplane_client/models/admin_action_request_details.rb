...
module OCI
  ...
  class HydraControlplaneClient::Models::AdminActionRequestDetails
    # **[Required]** Who is doing it.
    # @return [String]
    attr_accessor :user_id

    # **[Required]** Machine used.
    # @return [String]
    attr_accessor :host_name

    # **[Required]** Task executed.
    # @return [String]
    attr_accessor :task

    # **[Required]** List of parameters.
    # @return [Array<OCI::HydraControlplaneClient::Models::ActionRequestParameter>]
    ...
    def self.swagger_types
      {
        ...
        'host_name': :'String',
        'task': :'String',
        'parameters': :'Array<OCI::HydraControlplaneClient::Models::ActionRequestParameter>',
        'etag': :'String'
        # rubocop:enable Style/SymbolLiteral
      }
    end
    ...
    # @option attributes [String] :task The value to assign to the {#task} property
    # @option attributes [Array<OCI::HydraControlplaneClient::Models::ActionRequestParameter>] :parameters The value to assign to the {#parameters} property
    ...
    def hash
      [user_id, host_name, task, parameters, etag].hash
    end
