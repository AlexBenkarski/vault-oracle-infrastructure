...
module OCI
  ...
  #
  class HydraControlplaneClient::Models::ServiceRegistry
    ...
    def hash
      [id, lifecycle_state, tenancy_id, compartment_id, service_principal_name, display_name, name, namespace, email, jira_queue, ingestion_allowed_tenancies, is_hidden_in_registry_list, is_notifying_log_reclamation, is_implementing_get_logging, service_type, service_stage, time_created, time_last_modified, la_allowed_tenancies, test_allowed_tenancies].hash
    end
