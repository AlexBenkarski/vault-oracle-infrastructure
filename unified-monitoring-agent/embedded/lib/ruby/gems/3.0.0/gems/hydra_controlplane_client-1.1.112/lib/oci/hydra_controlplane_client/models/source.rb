...
module OCI
  ...
  class HydraControlplaneClient::Models::Source
    SOURCE_TYPE_ENUM = [
      SOURCE_TYPE_OCISERVICE = 'OCISERVICE'.freeze,
      SOURCE_TYPE_SIEM = 'SIEM'.freeze,
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::HydraControlplaneClient::Models::SiemService' if type == 'SIEM'
      return 'OCI::HydraControlplaneClient::Models::OciService' if type == 'OCISERVICE'

      # TODO: Log a warning when the subtype is not found.
      'OCI::HydraControlplaneClient::Models::Source'
    end
