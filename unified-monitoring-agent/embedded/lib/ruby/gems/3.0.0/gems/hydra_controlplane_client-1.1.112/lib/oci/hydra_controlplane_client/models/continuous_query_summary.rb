...
module OCI
  ...
  #
  class HydraControlplaneClient::Models::ContinuousQuerySummary
    ...
    def hash
      [id, query, compartment_id, time_created, time_last_modified, query_start_time, interval_in_minutes, threshold, display_name, custom_log_id, defined_tags, freeform_tags, is_enabled, description, recommendation_text, lifecycle_state, severity, operator].hash
    end
