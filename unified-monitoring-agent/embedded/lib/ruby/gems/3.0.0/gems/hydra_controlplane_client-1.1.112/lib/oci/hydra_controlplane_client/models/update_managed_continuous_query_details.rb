...
module OCI
  # Managed Continuous Query update object.
  class HydraControlplaneClient::Models::UpdateManagedContinuousQueryDetails
    ...
    def hash
      [query, stream_id, interval_in_minutes, threshold, display_name, defined_tags, freeform_tags, query_start_time, is_enabled, description, severity, operator].hash
    end
