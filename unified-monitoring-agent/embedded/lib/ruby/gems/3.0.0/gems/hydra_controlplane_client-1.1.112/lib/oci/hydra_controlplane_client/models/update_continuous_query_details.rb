...
module OCI
  ...
  class HydraControlplaneClient::Models::UpdateContinuousQueryDetails
    ...
    def hash
      [query, interval_in_minutes, threshold, display_name, custom_log_id, defined_tags, freeform_tags, query_start_time, is_enabled, description, recommendation_text, severity, operator].hash
    end
