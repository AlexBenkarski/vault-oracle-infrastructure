...
module OCI
  # The details of the service category to be created.
  #
  class HydraControlplaneClient::Models::CreateServiceCategoryDetails
    ...
    def hash
      [name, display_name, endpoint, is_proxy_enabled, resource_type, category_stage, is_logging_enabled, parameters].hash
    end
