...
module OCI
  # A ManagedContinuousQuery that can be used to save and share a given search result.
  #
  class HydraControlplaneClient::Models::ManagedContinuousQuerySummary
    ...
    # lifecycle state of managed continuous query
    # @return [String]
    attr_accessor :lifecycle_state

    # **[Required]** The state of the ManagedContinuousQuerySeverity
    # @return [String]
    attr_accessor :severity

    # **[Required]** operator used in managed continuous query
    # @return [String]
    ...
    def hash
      [id, query, compartment_id, stream_id, time_created, time_last_modified, query_start_time, interval_in_minutes, threshold, display_name, defined_tags, freeform_tags, is_enabled, description, lifecycle_state, severity, operator].hash
    end
