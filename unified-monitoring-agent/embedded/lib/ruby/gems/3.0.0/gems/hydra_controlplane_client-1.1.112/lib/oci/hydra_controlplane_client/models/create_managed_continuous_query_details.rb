...
module OCI
  # Managed Continuous Query create object.
  class HydraControlplaneClient::Models::CreateManagedContinuousQueryDetails
    ...
    def hash
      [query, compartment_id, stream_id, interval_in_minutes, threshold, display_name, defined_tags, freeform_tags, query_start_time, is_enabled, description, severity, operator].hash
    end
