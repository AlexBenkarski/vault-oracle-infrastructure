...
module OCI
  ...
  class HydraControlplaneClient::Models::UnifiedAgentServiceConfigurationDetails
    ...
    def self.get_subtype(object_hash)
      ...
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentLoggingConfiguration' if type == 'LOGGING'
      return 'OCI::HydraControlplaneClient::Models::UnifiedAgentMonitoringConfigurationDetails' if type == 'MONITORING'

      # TODO: Log a warning when the subtype is not found.
      'OCI::HydraControlplaneClient::Models::UnifiedAgentServiceConfigurationDetails'
    end
