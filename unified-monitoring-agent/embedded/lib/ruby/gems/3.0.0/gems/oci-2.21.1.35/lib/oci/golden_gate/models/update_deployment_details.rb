...
module OCI
  ...
  class GoldenGate::Models::UpdateDeploymentDetails
    ...
    def hash
      [display_name, license_model, description, freeform_tags, defined_tags, nsg_ids, subnet_id, load_balancer_subnet_id, is_public, fqdn, cpu_core_count, is_auto_scaling_enabled, ogg_data, maintenance_window, maintenance_configuration].hash
    end
