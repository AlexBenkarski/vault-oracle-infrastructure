...
module OCI
  ...
  class FileStorage::Models::MountTarget
    ...
    def hash
      [availability_domain, compartment_id, display_name, export_set_id, id, lifecycle_details, lifecycle_state, private_ip_ids, subnet_id, idmap_type, ldap_idmap, nsg_ids, kerberos, time_billing_cycle_end, observed_throughput, requested_throughput, reserved_storage_capacity, time_created, freeform_tags, defined_tags].hash
    end
