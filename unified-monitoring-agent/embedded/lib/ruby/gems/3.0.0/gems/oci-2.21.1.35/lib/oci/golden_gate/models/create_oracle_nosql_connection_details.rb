...
module OCI
  ...
  class GoldenGate::Models::CreateOracleNosqlConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, locks, vault_id, key_id, nsg_ids, subnet_id, routing_method, technology_type, tenancy_id, region, user_id, private_key_file, private_key_passphrase, public_key_fingerprint].hash
    end
