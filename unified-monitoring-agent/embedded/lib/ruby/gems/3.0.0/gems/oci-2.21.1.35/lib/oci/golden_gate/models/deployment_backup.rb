...
module OCI
  ...
  class GoldenGate::Models::DeploymentBackup
    ...
    def hash
      [id, deployment_id, deployment_type, compartment_id, display_name, is_automatic, lifecycle_state, lifecycle_details, time_of_backup, time_backup_finished, size_in_bytes, backup_type, ogg_version, namespace_name, bucket_name, object_name, time_created, time_updated, freeform_tags, defined_tags, system_tags, locks].hash
    end
