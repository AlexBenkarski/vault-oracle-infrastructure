...
module OCI
  ...
  class FleetAppsManagement::Models::FleetResource
    ...
    def hash
      [id, tenancy_id, resource_region, time_created, time_updated, compartment_id, display_name, resource_id, compartment, compliance_state, tenancy_name, resource_type, product_count, target_count, product, application_type, environment_type, lifecycle_state, lifecycle_details, system_tags].hash
    end
