...
module OCI
  ...
  class FileStorage::Models::CreateFileSystemDetails
    ...
    def hash
      [availability_domain, compartment_id, display_name, freeform_tags, defined_tags, kms_key_id, source_snapshot_id, clone_attach_status, filesystem_snapshot_policy_id].hash
    end
