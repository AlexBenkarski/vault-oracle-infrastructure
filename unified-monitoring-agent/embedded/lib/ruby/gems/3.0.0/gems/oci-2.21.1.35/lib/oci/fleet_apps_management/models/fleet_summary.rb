...
module OCI
  ...
  class FleetAppsManagement::Models::FleetSummary
    ...
    # **[Required]** The current state of the Fleet.
    # @return [String]
    ...
    def hash
      [id, compartment_id, resource_region, display_name, time_created, time_updated, fleet_type, environment_type, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
