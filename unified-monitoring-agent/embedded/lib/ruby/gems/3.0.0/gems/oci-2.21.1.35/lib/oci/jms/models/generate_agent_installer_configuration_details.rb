...
module OCI
  ...
  class Jms::Models::GenerateAgentInstallerConfigurationDetails
    # **[Required]** The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the install key for which to generate the configuration file.
    # @return [String]
