...
module OCI
  ...
  class FleetAppsManagement::Models::RunbookSummary
    ...
    # @return [String]
    attr_accessor :runbook_relevance
    ...
    def hash
      [id, display_name, description, type, runbook_relevance, operation, os_type, platform, is_default, estimated_time, lifecycle_state, lifecycle_details, time_created, time_updated, compartment_id, resource_region, freeform_tags, defined_tags, system_tags].hash
    end
