...
module OCI
  ...
  class GenerativeAiInference::Models::CohereChatRequest < GenerativeAiInference::Models::BaseChatRequest
    ...
    def hash
      [api_format, message, chat_history, documents, is_search_queries_only, preamble_override, is_stream, max_tokens, temperature, top_k, top_p, prompt_truncation, frequency_penalty, presence_penalty, seed, is_echo, tools, tool_results, is_force_single_step, stop_sequences, is_raw_prompting, citation_quality].hash
    end
