...
module OCI
  ...
  class FleetAppsManagement::Models::MaintenanceWindow
    MAINTENANCE_WINDOW_TYPE_ENUM = [
      ...
      MAINTENANCE_WINDOW_TYPE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # **[Required]** Duration if schedule type is Custom
    # @return [String]
    attr_accessor :duration

    # **[Required]** Is this is a recurring maintenance window
    # @return [BOOLEAN]
    ...
    # **[Required]** Task initiation cutoff
    # @return [Integer]
    ...
    def maintenance_window_type=(maintenance_window_type)
      ...
      if maintenance_window_type && !MAINTENANCE_WINDOW_TYPE_ENUM.include?(maintenance_window_type)
        OCI.logger.debug("Unknown value for 'maintenance_window_type' [" + maintenance_window_type + "]. Mapping to 'MAINTENANCE_WINDOW_TYPE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @maintenance_window_type = MAINTENANCE_WINDOW_TYPE_UNKNOWN_ENUM_VALUE
      else
    ...
    def hash
      [id, compartment_id, resource_region, display_name, description, time_created, time_updated, maintenance_window_type, is_outage, time_schedule_start, duration, is_recurring, recurrences, task_initiation_cutoff, lifecycle_state, lifecycle_details, freeform_tags, defined_tags, system_tags].hash
    end
