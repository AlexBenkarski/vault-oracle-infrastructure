...
module OCI
  ...
  class GoldenGate::Models::OracleConnectionSummary < GoldenGate::Models::ConnectionSummary
    ...
    def hash
      [connection_type, id, display_name, description, compartment_id, freeform_tags, defined_tags, system_tags, lifecycle_state, lifecycle_details, time_created, time_updated, vault_id, key_id, ingress_ips, nsg_ids, subnet_id, routing_method, locks, technology_type, username, connection_string, authentication_mode, session_mode, private_ip, database_id].hash
    end
