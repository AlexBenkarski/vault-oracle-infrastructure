...
module OCI
  ...
  class FileStorage::Models::CreateMountTargetDetails
    ...
    def hash
      [availability_domain, compartment_id, display_name, hostname_label, ip_address, subnet_id, idmap_type, ldap_idmap, nsg_ids, kerberos, freeform_tags, defined_tags, requested_throughput].hash
    end
