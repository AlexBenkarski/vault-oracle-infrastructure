...
module OCI
  ...
  #
  class Opsi::Models::HostContainers < Opsi::Models::HostPerformanceMetricGroup
    # Container Id (full)
    # @return [String]
    ...
    def hash
      [metric_name, time_collected, container_id, container_name, container_image, container_ports].hash
    end
