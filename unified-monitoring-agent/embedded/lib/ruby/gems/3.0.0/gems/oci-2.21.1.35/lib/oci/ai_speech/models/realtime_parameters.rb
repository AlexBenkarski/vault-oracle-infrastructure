...
module OCI
  ...
  class AiSpeech::Models::RealtimeParameters
    ...
    def hash
      [encoding, is_ack_enabled, partial_silence_threshold_in_ms, final_silence_threshold_in_ms, stabilize_partial_results, model_domain, language_code, should_ignore_invalid_customizations, customizations].hash
    end
