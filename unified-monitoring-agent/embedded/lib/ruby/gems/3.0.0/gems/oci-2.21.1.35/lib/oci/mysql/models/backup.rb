...
module OCI
  ...
  class Mysql::Models::Backup
    ...
    def hash
      [id, display_name, description, compartment_id, time_created, time_updated, lifecycle_state, lifecycle_details, backup_type, creation_type, db_system_id, db_system_snapshot, backup_size_in_gbs, retention_in_days, data_storage_size_in_gbs, mysql_version, shape_name, freeform_tags, defined_tags, immediate_source_backup_id, original_source_backup_id, time_copy_created].hash
    end
