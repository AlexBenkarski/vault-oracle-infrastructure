...
module OCI
  ...
  class FleetAppsManagement::Models::CreateMaintenanceWindowDetails
    ...
    def initialize(attributes = {})
      ...
      self.maintenance_window_type = "OPEN_ENDED" if maintenance_window_type.nil? && !attributes.key?(:'maintenanceWindowType') # rubocop:disable Style/StringLiterals
      ...
      self.maintenance_window_type = "OPEN_ENDED" if maintenance_window_type.nil? && !attributes.key?(:'maintenanceWindowType') && !attributes.key?(:'maintenance_window_type') # rubocop:disable Style/StringLiterals
    ...
    def hash
      [compartment_id, display_name, description, is_outage, maintenance_window_type, time_schedule_start, duration, is_recurring, recurrences, task_initiation_cutoff, freeform_tags, defined_tags].hash
    end
