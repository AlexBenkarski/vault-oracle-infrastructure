...
module OCI
  ...
  class GoldenGate::Models::CreateDb2ConnectionDetails < GoldenGate::Models::CreateConnectionDetails
    ...
    # **[Required]** The password Oracle GoldenGate uses to connect the associated DB2 database.
    #
    # @return [String]
    ...
    def hash
      [connection_type, display_name, description, compartment_id, freeform_tags, defined_tags, locks, vault_id, key_id, nsg_ids, subnet_id, routing_method, technology_type, database_name, host, port, username, password, additional_attributes, security_protocol, ssl_client_keystoredb, ssl_client_keystash, ssl_server_certificate].hash
    end
