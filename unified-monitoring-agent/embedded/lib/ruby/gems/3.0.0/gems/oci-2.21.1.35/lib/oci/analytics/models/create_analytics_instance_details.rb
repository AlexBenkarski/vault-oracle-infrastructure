...
module OCI
  ...
  class Analytics::Models::CreateAnalyticsInstanceDetails
    ...
    def hash
      [name, description, compartment_id, feature_set, capacity, license_type, email_notification, network_endpoint_details, idcs_access_token, defined_tags, freeform_tags, kms_key_id, domain_id, admin_user, feature_bundle].hash
    end
