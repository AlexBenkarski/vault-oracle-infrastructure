...
module OCI
  ...
  class DatabaseManagement::DbManagementClient
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/databasemanagement/disable_autonomous_database_management_feature.rb.html) to see an example of how to use disable_autonomous_database_management_feature API.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/databasemanagement/enable_autonomous_database_management_feature.rb.html) to see an example of how to use enable_autonomous_database_management_feature API.
    ...
    #   retry configuration defined by {#retry_config} will be used. If an explicit `nil` value is provided then the operation will not retry
    # @option opts [String] :opc_request_id The client request ID for tracing.
    # @option opts [String] :peer_database_compartment_id The [OCID](https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment for which peer database metrics are required.
    #   This is not a mandatory parameter and in its absence, all the peer database metrics are returned.
    #
    # @option opts [String] :filter_by_metric_names The filter used to retrieve a specific set of metrics by passing the desired metric names with a comma separator. Note that, by default, the service returns all supported metrics.
    # @return [Response] A Response object with data of type {OCI::DatabaseManagement::Models::DataguardPerformanceMetrics DataguardPerformanceMetrics}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/databasemanagement/get_dataguard_performance_metrics.rb.html) to see an example of how to use get_dataguard_performance_metrics API.
    ...
    # @option opts [String] :compare_type The time window used for metrics comparison.
    # @option opts [String] :filter_by_metric_names The filter used to retrieve a specific set of metrics by passing the desired metric names with a comma separator. Note that, by default, the service returns all supported metrics.
    # @return [Response] A Response object with data of type {OCI::DatabaseManagement::Models::PeerDatabaseMetrics PeerDatabaseMetrics}
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/databasemanagement/get_peer_database_metrics.rb.html) to see an example of how to use get_peer_database_metrics API.
    ...
    #    (default to false)
    # @option opts [BOOLEAN] :is_dns_resolution_enabled The option to filter Database Management private endpoints which are endbled with DNS proxy server. This should be used along with the vcnId query parameter.
    ...
    #
    # @return [Response] A Response object with data of type nil
    # @note Click [here](https://docs.cloud.oracle.com/en-us/iaas/tools/ruby-sdk-examples/latest/databasemanagement/modify_autonomous_database_management_feature.rb.html) to see an example of how to use modify_autonomous_database_management_feature API.
