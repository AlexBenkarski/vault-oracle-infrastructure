...
module OCI
  ...
  class Database::Models::CreateExascaleDbStorageVaultDetails
    ...
    def hash
      [compartment_id, display_name, description, availability_domain, time_zone, high_capacity_database_storage, additional_flash_cache_in_percent, freeform_tags, defined_tags].hash
    end
