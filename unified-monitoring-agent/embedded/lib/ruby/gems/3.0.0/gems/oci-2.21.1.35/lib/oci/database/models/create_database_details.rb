...
module OCI
  ...
  class Database::Models::CreateDatabaseDetails
    ...
    def hash
      [db_name, db_unique_name, database_software_image_id, pdb_name, admin_password, tde_wallet_password, character_set, ncharacter_set, db_workload, db_backup_config, freeform_tags, defined_tags, kms_key_id, kms_key_version_id, vault_id, sid_prefix, key_store_id].hash
    end
