...
module OCI
  ...
  class FleetAppsManagement::Models::ActionGroupDetails
    ...
    # **[Required]** The ID of the ActionGroup resource .
    # Ex:fleetId.
    #
    # @return [String]
    ...
    def hash
      [resource_id, name, type, application_type, product, lifecycle_operation, activity_id, status, time_started, time_ended, runbook_id].hash
    end
