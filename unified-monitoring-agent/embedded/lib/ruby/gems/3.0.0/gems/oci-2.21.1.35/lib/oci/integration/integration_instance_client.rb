...
module OCI
  ...
  class Integration::IntegrationInstanceClient
    ...
    def list_integration_instances(compartment_id, opts = {})
      ...
      if opts[:lifecycle_state] && !%w[CREATING UPDATING ACTIVE INACTIVE DELETING DELETED FAILED STANDBY].include?(opts[:lifecycle_state])
        raise 'Invalid value for "lifecycle_state", must be one of CREATING, UPDATING, ACTIVE, INACTIVE, DELETING, DELETED, FAILED, STANDBY.'
      end
