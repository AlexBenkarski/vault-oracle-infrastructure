...
module OCI
  ...
  class DataScience::Models::UpdatePipelineDetails
    ...
    def hash
      [display_name, description, configuration_details, infrastructure_configuration_details, log_configuration_details, step_details, freeform_tags, defined_tags].hash
    end
