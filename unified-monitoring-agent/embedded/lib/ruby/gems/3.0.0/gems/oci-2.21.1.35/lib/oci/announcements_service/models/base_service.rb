...
module OCI
  ...
  class AnnouncementsService::Models::BaseService
    ...
    def comms_manager_name=(comms_manager_name)
      raise "Invalid value for 'comms_manager_name': this must be one of the values in COMMS_MANAGER_NAME_ENUM." if comms_manager_name && !COMMS_MANAGER_NAME_ENUM.include?(comms_manager_name)
