...
module OCI
  ...
  class Analytics::Models::AnalyticsInstance
    ...
    def hash
      [id, name, description, compartment_id, lifecycle_state, feature_set, capacity, license_type, email_notification, network_endpoint_details, private_access_channels, vanity_url_details, service_url, defined_tags, freeform_tags, system_tags, kms_key_id, time_created, time_updated, feature_bundle, domain_id].hash
    end
