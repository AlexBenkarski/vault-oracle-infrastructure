...
module OCI
  ...
  class Database::Models::UpdateExadbVmClusterDetails
    ...
    def hash
      [display_name, total_e_cpu_count, enabled_e_cpu_count, vm_file_system_storage, node_count, license_model, ssh_public_keys, nsg_ids, backup_network_nsg_ids, freeform_tags, defined_tags, data_collection_options, system_version, grid_image_id, update_action].hash
    end
