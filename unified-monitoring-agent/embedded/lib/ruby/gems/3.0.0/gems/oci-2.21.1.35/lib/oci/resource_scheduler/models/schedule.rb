...
module OCI
  ...
  class ResourceScheduler::Models::Schedule
    ...
    def hash
      [id, compartment_id, display_name, description, action, recurrence_details, recurrence_type, resource_filters, resources, time_starts, time_ends, time_created, time_updated, time_last_run, time_next_run, lifecycle_state, freeform_tags, defined_tags, system_tags].hash
    end
