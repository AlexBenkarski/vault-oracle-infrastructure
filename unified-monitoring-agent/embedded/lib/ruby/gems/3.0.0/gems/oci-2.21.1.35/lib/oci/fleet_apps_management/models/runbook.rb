...
module OCI
  ...
  class FleetAppsManagement::Models::Runbook
    ...
    RUNBOOK_RELEVANCE_ENUM = [
      RUNBOOK_RELEVANCE_PRODUCT_GROUP = 'PRODUCT_GROUP'.freeze,
      RUNBOOK_RELEVANCE_PRODUCT = 'PRODUCT'.freeze,
      RUNBOOK_RELEVANCE_UNKNOWN_ENUM_VALUE = 'UNKNOWN_ENUM_VALUE'.freeze
    ].freeze
    ...
    # **[Required]** Type of runbook structure.
    # @return [String]
    attr_reader :runbook_relevance

    # **[Required]** The lifecycle operation performed by the task.
    # @return [String]
    attr_accessor :operation

    # **[Required]** The OS type for the runbook.
    # @return [String]
    attr_reader :os_type

    # **[Required]** The platform of the runbook.
    # @return [String]
    ...
    # @return [OCI::FleetAppsManagement::Models::Associations]
    ...
    def self.swagger_types
      {
        ...
        'associations': :'OCI::FleetAppsManagement::Models::Associations',
    ...
    # @option attributes [String] :runbook_relevance The value to assign to the {#runbook_relevance} property
    ...
    # @option attributes [OCI::FleetAppsManagement::Models::Associations] :associations The value to assign to the {#associations} property
    ...
    def initialize(attributes = {})
      ...
      self.runbook_relevance = attributes[:'runbookRelevance'] if attributes[:'runbookRelevance']

      raise 'You cannot provide both :runbookRelevance and :runbook_relevance' if attributes.key?(:'runbookRelevance') && attributes.key?(:'runbook_relevance')

      self.runbook_relevance = attributes[:'runbook_relevance'] if attributes[:'runbook_relevance']
      ...
      self.associations = attributes[:'associations'] if attributes[:'associations']
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] runbook_relevance Object to be assigned
    def runbook_relevance=(runbook_relevance)
      # rubocop:disable Style/ConditionalAssignment
      if runbook_relevance && !RUNBOOK_RELEVANCE_ENUM.include?(runbook_relevance)
        OCI.logger.debug("Unknown value for 'runbook_relevance' [" + runbook_relevance + "]. Mapping to 'RUNBOOK_RELEVANCE_UNKNOWN_ENUM_VALUE'") if OCI.logger
        @runbook_relevance = RUNBOOK_RELEVANCE_UNKNOWN_ENUM_VALUE
      else
        @runbook_relevance = runbook_relevance
      end
      # rubocop:enable Style/ConditionalAssignment
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        type == other.type &&
        runbook_relevance == other.runbook_relevance &&
    ...
    def hash
      [id, display_name, description, type, runbook_relevance, operation, os_type, platform, is_default, estimated_time, lifecycle_state, lifecycle_details, time_created, time_updated, associations, compartment_id, resource_region, freeform_tags, defined_tags, system_tags].hash
    end
