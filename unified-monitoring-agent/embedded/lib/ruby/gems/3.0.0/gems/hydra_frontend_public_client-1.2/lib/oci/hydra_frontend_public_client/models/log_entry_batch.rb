...
module OCI
  ...
  class HydraFrontendPublicClient::Models::LogEntryBatch
    # **[Required]** List of data entries.
    # @return [Array<OCI::HydraFrontendPublicClient::Models::LogEntry>]
    ...
    def self.swagger_types
      {
        # rubocop:disable Style/SymbolLiteral
        'entries': :'Array<OCI::HydraFrontendPublicClient::Models::LogEntry>',
        'source': :'String',
        'type': :'String',
        'subject': :'String',
    ...
    # @option attributes [Array<OCI::HydraFrontendPublicClient::Models::LogEntry>] :entries The value to assign to the {#entries} property
